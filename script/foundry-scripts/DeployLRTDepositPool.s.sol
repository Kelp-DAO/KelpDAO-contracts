...
contract DeployLRTDepositPool is Script {
    ...
    function run() external {
        ...
        nodeDelegatorProxy1 = NodeDelegator(0x89cD79e873DEA08D1AfA173B9160c8D31e4Bc9f0);
        nodeDelegatorProxy2 = NodeDelegator(0x5c5720246d3210E90875015c8439230c027a104b);
        nodeDelegatorProxy3 = NodeDelegator(0x68FBD2a42e5d598dA91161f69a8346aFc9Ad9BA8);
        nodeDelegatorProxy4 = NodeDelegator(0x6E6a5770A3A9A8b8614600d5F0A9d6bDc695CF68);
        nodeDelegatorProxy5 = NodeDelegator(0x51975b2e6E29738B8aaaC8479f929a04c5E1D54c);
